...
a.container&&(a.container=a.target);a.autoResize&&c(window).resize(function(){c(a.target+"."+a.selectClass).trigger("mouseenter")});return this.each(function(){function k(e,c){c=="return"?a.returnStart(e):a.hoverStart(e);e||(e=b);if(!a.includeMargins){h=d(e.css("marginLeft"));i=d(e.css("marginTop"))}var g={left:e.position().left+h,top:e.position().top+i,width:e.outerWidth(true)-l,height:e.outerHeight(true)-m};f.stop().animate(g,a.speed,a.fx,function(){c=="return"?a.returnFinish(e):a.hoverFinish(e)})}c(this).css("position")==
